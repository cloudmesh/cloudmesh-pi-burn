...
class Burner(object):
    ...
    def add_to_hosts(self, ip=None, etc_hosts=None):
        ...
        return writefile_cat('/etc/hosts', config + "\n")

    def write_cluster_hosts(self, cluster_hosts=None, hosts=None):
        hosts = hosts + '\n'
